---
description: >-
  These tools are not a replacement for manually scanning and investigating
  systems.
---
...
![Yuki](../.gitbook/assets/maxresdefault-1-1.jpg)
...
* [**TheHarvester**](https://gbhackers.com/theharvester-advanced-information-gathering-tool-for-pen-testers/)
* **Metagoofil**
* **DNSRecon**
* **Sublist3r**
* [**Wafw00f**](https://gbhackers.com/web-application-firewall-detection-using-kali-linux-wafw00f/)
* **WAFNinja**
* [**XSS Scanner**](https://gbhackers.com/xssight-automated-xss-scanner-and-payload-injector/)
* **WhatWeb**
* **Spaghetti**
* [**WPscan**](https://gbhackers.com/penetration-testing-wordpress-website/)
* **WPscanner**
* **WPSeku**
* **Droopescan \( CMS Vulnerability Scanner WordPress, Joomla, Silverstripe, Drupal, And Moodle\)**
* **SSLScan**
* [**SSLyze**](https://gbhackers.com/fast-and-complete-ssl-scanner-to-find-mis-configurations-affecting-tlsssl-severs-a-detailed-analysis/)
* **A2SV**
* **Dirsearch**
